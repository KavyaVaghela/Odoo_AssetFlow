...
export default function Login() {
  ...
  // React Router Dom logic inside a try/catch in case App is not fully wrapped in BrowserRouter yet for isolated testing
  let navigate;
  try {
    navigate = useNavigate();
  } catch(e) {
    navigate = (path) => console.log('Simulating navigation to:', path);
  }
  ...
  return (
    <div className="min-h-screen w-full flex bg-gray-50 dark:bg-black font-sans text-gray-900 dark:text-gray-100">
      ...
      <div className="hidden lg:flex w-[45%] bg-[#0F172A] relative flex-col justify-between p-12 overflow-hidden">
        {/* Background Decorative Shapes for abstract illustration */}
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm font-medium text-[#2563EB] hover:text-blue-700 transition-colors focus:outline-none focus:underline">
                  Forgot Password?
                </a>
              </div>
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <span className="text-xs text-gray-400 dark:text-gray-500 font-medium tracking-wider">OR CONTINUE WITH</span>
              <div className="flex-1 h-px bg-gray-200 dark:bg-gray-800" />
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button 
                ...
                className="flex items-center justify-center gap-2 py-2.5 border border-gray-200 dark:border-gray-800 rounded-[20px] hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#2563EB]"
              >
